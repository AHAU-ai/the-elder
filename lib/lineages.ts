...
export const LINEAGES: Record<LineageKey, Lineage> = {
  ...
  maya: {
    ...
    overlay: {
      ...
      epistemicMode: 'through the Popol Wuj and the Ajq'ij transmission — knowing arrives through the corn-survival arc: the seed underground, the houses of ordeal, the harvest, the final burn and return',
